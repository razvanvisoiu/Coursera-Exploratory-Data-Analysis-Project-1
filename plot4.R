...
plot(date_time,data_February_2007$Global_active_power,type='l',xlab='',ylab='Global Active Power')

plot(date_time,data_February_2007$Voltage,type='l',xlab='datetime',ylab='Voltage')
...
plot(date_time,data_February_2007$Global_reactive_power,type='l',xlab='datetime',ylab='Global_reactive_power')
dev.off()
